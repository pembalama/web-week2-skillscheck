...
let me = {
    firstName: 'Pemba',
    superHeroName: 'The Drunken Master',
    homeTown: 'Dallas',
    superPowers: ['Drinking alone', 'Drinking with friends', 'Drinking with Strangers'],
...
function setColor(arr){
    let remColor = arr.splice(3);
    for(i = 0; i < remColor.length; i++){
    if(remColor[i] === 'blue') {
        remColor[i] === '#4D4DFF';
        }
    }
